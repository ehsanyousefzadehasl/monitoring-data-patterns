...
def risk2_per_metric(stats, w=RISK_V2_W):
    ...
    return {
        ...
        "RISK2": (w["w_mean"]*mean_v + w["w_p95"]*p95_v + w["w_p50"]*p50_v + w["w_ema"]*ema_v)
    }
...
def build_md(params, sS, sO, sD, rS, rO, rD, r2S, r2O, r2D, imgs):
    ...
    md = (
        ...
        f"- SMACT: center={params['S_C']}, width={params['S_W']}, amp={params['S_A']}, tail_start={params['S_TS']}, tau={params['S_TAU']}, tail_amp={params['S_TA']}\n"
        f"- SMOCC: center={params['O_C']}, width={params['O_W']}, amp={params['O_A']}, tail_start={params['O_TS']}, tau={params['O_TAU']}, tail_amp={params['O_TA']}\n"
        f"- DRAMA: center={params['D_C']}, width={params['D_W']}, amp={params['D_A']}, tail_start={params['D_TS']}, tau={params['D_TAU']}, tail_amp={params['D_TA']}\n\n"
