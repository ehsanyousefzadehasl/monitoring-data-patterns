...
RISK_V2_W = {
    "w_mean": 0.20,
    "w_p95":  0.30,
    "w_p50":  0.30,  # p50 weight set to 0.3
    "w_ema":  0.20,
}
...
def build_md(params, sS, sO, sD, rS, rO, rD, r2S, r2O, r2D, imgs):
    ...
    md = (
        ...
        "Bimodal:\n"
        f"- SMACT: low={params['S_L']}, high={params['S_H']}, period={params['S_P']}, duty={params['S_D']}, jitter={params['S_J']}, random_phase={params['S_RP']}\n"
        f"- SMOCC: low={params['O_L']}, high={params['O_H']}, period={params['O_P']}, duty={params['O_D']}, jitter={params['O_J']}, random_phase={params['O_RP']}\n"
        f"- DRAMA: low={params['D_L']}, high={params['D_H']}, period={params['D_P']}, duty={params['D_D']}, jitter={params['D_J']}, random_phase={params['D_RP']}\n\n"
